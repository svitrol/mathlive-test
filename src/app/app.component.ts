...
import {addCustomMacrosAndShortcuts} from "./symbol-macros-shortcuts";
...
export class AppComponent {
  ...
  ngOnInit(){
    ...
    this.addFunctionToMap('Funkce2', 'Popis A', '0ba9b0ce-44a9-4c56-a39c-005a8fafc507', 2);
  ...
  private addSymbolToMap(symbolName: string, description: string, unitId: string) {
    this.mySymbolMap.set(symbolName, new CustomSymbol({'symbolName': symbolName, 'description': description, 'unitId': unitId}));
  }
